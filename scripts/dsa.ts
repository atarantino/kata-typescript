...
export type DsaSpec = ClassSpec | FunctionSpec;
export type DsaCatalog = Record<string, DsaSpec>;

const length_property: Pick<ClassSpec, "properties"> = {
    properties: [
        {
            name: "length",
            type: "number",
...
const list_interface: Pick<ClassSpec, "methods" | "properties"> = {
    methods: [
        {
            name: "prepend",
            args: "item: T",
...
} satisfies DsaCatalog;

export type DsaName = keyof typeof dsa;
